...
The `4.5` Linux kernel comes from the [linux-stable][linux-stable] repository. Switching to another kernel like the `4.4.5` or `4.1.19` *LTS* kernels is easy.
