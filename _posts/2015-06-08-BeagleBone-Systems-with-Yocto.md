...
The `4.4.0-rc6` Linux kernel comes from the [linux-stable][linux-stable] repository. Switching to another kernel like the `4.1.15` *LTS* kernel is easy.
