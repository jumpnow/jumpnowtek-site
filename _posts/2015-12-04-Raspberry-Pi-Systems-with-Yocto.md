...
I have done some testing with the following boards using the `4.4.30` kernel
...
The `4.4.30` Linux kernel comes from the [github.com/raspberrypi/linux][rpi-kernel] repository.
...
As of 2016-11-03, here is the list of DTS overlays that are installed with the `4.4.30` kernel running on an RPi3

    root@rpi3:~# uname -a
    Linux rpi3 4.4.30 #1 SMP Wed Nov 2 08:22:54 EDT 2016 armv7l armv7l armv7l GNU/Linux
