...
I have done some testing with the following boards using the `4.4.27` kernel
...
The `4.4.27` Linux kernel comes from the [github.com/raspberrypi/linux][rpi-kernel] repository.
