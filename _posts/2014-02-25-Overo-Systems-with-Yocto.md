...
These instructions are for building generic developer systems for [Gumstix Overo][overo] boards with a focus on C/C++ and Qt programmers. You will almost certainly want to modify the contents of the images for any particular project. 
